...
const UserInfo = () => {
    ...
    return (
        <Box style={{width: "100%", display: "flex", minHeight: 800}}>
            ...
            <Box style={{ display: "flex", margin: "auto", width: 1000}}>
                <Box style={{ margin: "auto", width: 1000, background: "#FFFFFF", padding: 20, borderRadius: 6, boxShadow: "0px 2px 4px rgba(168, 168, 168, 0.25)" }}>
                    ...
                    <Grid xs={12} container spacing={2}>
                        <Grid item xs={6}>
                            ...
                            <TextField onChange={(e) => handleChange(e)} name="cardDetail" variant="outlined" placeholder="Input Card Detail" fullWidth value={userNew?.cardDetail} />
                        </Grid>
                        <Grid item xs={6}>
